		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Detalle Marea",
									"targetURL": "#comtasamareaeventov2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtasamareaeventov2-display": {
								"semanticObject": "comtasamareaeventov2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.mareaeventov2",
									"url": sap.ui.require.toUrl("com/tasa/mareaeventov2")
								}
							}
						}
					}
