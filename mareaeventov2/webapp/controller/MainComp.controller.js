sap.ui.define([
	...
	return Controller.extend("com.tasa.mareaeventov2.controller.MainComp", {
        ...
        guardarMarea: async function () {
            ...
            if (guardarDatosMarea) {
                ...
                var flagCargaMarea = modelo.getProperty("/Utils/CargarMarea");
                if(success){
                    if(flagCargaMarea){
                        var me = this;
                        MessageBox.success("Se actualizó la marea correctamente.", {
                            title: "Éxito",
        ...
        setDetalleMarea: async function (data, navegar) {
            ...
            if (navegar) {
                ...
                BusyIndicator.show(0);
                sap.ui.controller("com.tasa.mareaeventov2.controller.Marea").validaFechaNulaEvt(this);
                await sap.ui.controller("com.tasa.mareaeventov2.controller.Marea").cargarCombos(this);
                await sap.ui.controller("com.tasa.mareaeventov2.controller.Marea").validarVista(this);
                BusyIndicator.hide();
            }
        ...
        navToExternalComp: function () {
            ...
            oStore.put("AppOrigin", "mareaeventov2");
