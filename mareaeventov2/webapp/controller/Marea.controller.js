sap.ui.define([
    ...
    function (Controller) {
        ...
        return Controller.extend("com.tasa.mareaeventov2.controller.Marea", {
            ...
            onAfterRendering: function() {
                ...
                var that = this;
                var oModelDataModelo = that.getOwnerComponent()._getPropertiesToPropagate().oModels.DataModelo;
                console.log("Propagate: ", this.getOwnerComponent());
                /*
                var dataModelo = oModelDataModelo.getData();
                this.getOwnerComponent().getModel("DetalleMarea").setData(dataModelo);
                this.getOwnerComponent().getModel("DetalleMarea").refresh();
                var flagCargaMarea = this.getOwnerComponent().getModel("DetalleMarea").getProperty("/Utils/CargarMarea");
                if(flagCargaMarea){
                    //si viene de reporte de mareas se debe implementar metodo getEventos
