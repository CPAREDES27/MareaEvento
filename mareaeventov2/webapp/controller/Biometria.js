sap.ui.define([
	...
	"com/tasa/mareaeventov2/controller/Utils",
	...
	return ManagedObject.extend("com.tasa.mareaeventov2.controller.Biometria", {
        ...
        getDialog_add_especie: function () {
            if (!this.oDialog_e) {
                this.oDialog_e = sap.ui.xmlfragment("com.tasa.mareaeventov2.fragments.Popup_especie", this);
        ...
        getDialog_add_Incidental: function () {
            if (!this.oDialog_I) {
                this.oDialog_I = sap.ui.xmlfragment("com.tasa.mareaeventov2.fragments.Popup_Incidental", this);
