sap.ui.define([
	...
	return ManagedObject.extend("com.tasa.mareaeventov2.controller.PescaDeclarada", {
        ...
        getDialog_add_especie: function () {
            if (!this.oDialog_e) {
                this.oDialog_e = sap.ui.xmlfragment("com.tasa.mareaeventov2.fragments.Popup_especie_pescaDcl", this);
