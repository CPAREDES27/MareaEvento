sap.ui.define([
	...
	return MainComp.extend("com.tasa.mareaeventov2.controller.Evento", {

        onInit: function () {
            
            this._vista = "";
            this.router = this.getOwnerComponent().getRouter();
            this.router.getRoute("Evento").attachPatternMatched(this._onPatternMatched, this);
        ...
        _onRouteMatched :async function(oEvent){
                ...
                if(urlIntance.indexOf('Evento') !== -1 ){
                    this._vista = "Evento";
                }else{
                    if(this._vista === "Evento"){
        ...
        getConfirmSaveDialogTest: function () {
            if (!this.oDialogConfirmSave) {
                this.oDialogConfirmSave = sap.ui.xmlfragment("com.tasa.mareaeventov2.view.fragments.EventoFinalizado", this);
        ...
        getConfirmDialog: function(){
            if (!this.oDialogConfirm) {
                this.oDialogConfirm = sap.ui.xmlfragment("com.tasa.mareaeventov2.view.fragments.Confirm", this);
        ...
        getDialog: function () {
            if (!this.oDialog) {
                this.oDialog = sap.ui.xmlfragment("com.tasa.mareaeventov2.view.fragments.Confirm", this);
        ...
        obtenerDatosDistribFlota : async function(){
            ...
            if (this._tipoEvento != "6") {
                ...
                if (this._FormMarea.EsNuevo == false ||  (this._FormMarea.EsNuevo && this._indicadorProp == "P")) {
                    await sap.ui.controller("com.tasa.mareaeventov2.controller.Marea").obtenerDatosDistribFlota(this);
